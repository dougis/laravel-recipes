      ...
      <div class="row">
        <div class="large-12 medium-12 small-12 columns text-center">
          <div class="head align-center">
            <h2 class="margin0">New recipes</h2>
            <h6 class="fontsans big"><strong>Recent recipes on the blog</strong></h6>
          </div>
        </div>
      </div>
      <!-- recipe list -->
          ...
          <div class="large-3 medium-6 small-12 columns" data-equalizer-watch>
            <div class="recipe text-center">
              <div class="recipe-cover">
                ...
                <a href="recipe.html" class="type">Dessert</a>
                <a class="recipe-link" href="recipe.html"></a>
                <img src="img/food1.jpg" alt="">
              </div>
              <h6 class="fontsans margin0"><a href="recipe.html">Momofuku Ooey Gooey Butter Cake Bars With Blueberries</a></h6>
            </div>
          </div>
          <div class="large-3 medium-6 small-12 columns" data-equalizer-watch>
            <div class="recipe text-center">
              <div class="recipe-cover">
                <a href="" class="like"><i class="fa fa-heart-o"></i> 2054</a>
                <a href="recipe.html" class="type">Main dish</a>
                <a class="recipe-link" href="recipe.html"></a>
                <img src="img/food2.jpg" alt="">
              </div>
              <h6 class="fontsans margin0"><a href="recipe.html">Turkey Grilled Cheese Sandwich With Pickled Onions</a></h6>
            </div>
          </div>
          <div class="large-3 medium-6 small-12 columns" data-equalizer-watch>
            <div class="recipe text-center">
              ...
              <h6 class="fontsans margin0"><a href="recipe.html">Toasted Oatmeal With Strawberry Chia Jam And Coconut Whipped Cream</a></h6>
            </div>
          </div>
          <div class="large-3 medium-6 small-12 columns" data-equalizer-watch>
            <div class="recipe text-center">
              ...
              <h6 class="fontsans margin0"><a href="recipe.html">Honey Lemon Grilled Chicken Recipe</a></h6>
            </div>
          </div>
          <div class="large-3 medium-6 small-12 columns" data-equalizer-watch>
            <div class="recipe text-center">
